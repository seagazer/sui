...
public class Roll3DView extends View {
    ...
    private void drawRollWhole3D(Canvas canvas, boolean draw2D) {
        ...
        if (direction == 1) {
            ...
            matrix.postTranslate(viewWidth / 2f, axisY);
            ...
            matrix.preTranslate(0, -viewHeight / 2f);
            matrix.postTranslate(axisX, viewHeight / 2f);
    ...
    private void drawSepartConbine(Canvas canvas) {
        for (int i = 0; i < partNumber; i++) {
            ...
            if (direction == 1) {
                ...
                matrix.preTranslate(-currBitmap.getWidth() / 2f, 0);
                matrix.postTranslate(currBitmap.getWidth() / 2f + i * averageWidth, axisY);
                ...
                matrix.preTranslate(-nextBitmap.getWidth() / 2f, -nextBitmap.getHeight());
                matrix.postTranslate(nextBitmap.getWidth() / 2f + i * averageWidth, axisY);
                ...
                matrix.preTranslate(0, -currBitmap.getHeight() / 2f);
                matrix.postTranslate(axisX, currBitmap.getHeight() / 2f + i * averageHeight);
                canvas.drawBitmap(currBitmap, matrix, paint);
                ...
                matrix.preTranslate(-nextBitmap.getWidth(), -nextBitmap.getHeight() / 2f);
                matrix.postTranslate(axisX, nextBitmap.getHeight() / 2f + i * averageHeight);
                canvas.drawBitmap(nextBitmap, matrix, paint);
            }
            canvas.restore();
        }
    ...
    private void drawRollInTurn(Canvas canvas) {
        for (int i = 0; i < partNumber; i++) {
            ...
            if (direction == 1) {
                ...
                matrix.preTranslate(0, -currBitmap.getHeight() / 2f);
                matrix.postTranslate(tAxisX, currBitmap.getHeight() / 2f + i * averageHeight);
                canvas.drawBitmap(currBitmap, matrix, paint);
                ...
                matrix.preTranslate(-nextBitmap.getWidth(), -nextBitmap.getHeight() / 2f);
                matrix.postTranslate(tAxisX, nextBitmap.getHeight() / 2f + i * averageHeight);
                canvas.drawBitmap(nextBitmap, matrix, paint);
            }
            canvas.restore();
        }
        ...
        for (int i = 0; i < partNumber; i++) {
            ...
            if (direction == 1) {
                if (rotateDegree < 90) {
                    ...
                    matrix.preTranslate(-currBitmap.getWidth() / 2f, -currBitmap.getHeight() / 2f);
                    matrix.postTranslate(currBitmap.getWidth() / 2f, currBitmap.getHeight() / 2f + i * averageHeight);
                    canvas.drawBitmap(currBitmap, matrix, paint);
                } else {
                    camera.save();
                    ...
                    matrix.preTranslate(-nextBitmap.getWidth() / 2f, -nextBitmap.getHeight() / 2f);
                    matrix.postTranslate(nextBitmap.getWidth() / 2f, nextBitmap.getHeight() / 2f + i * averageHeight);
                    canvas.drawBitmap(nextBitmap, matrix, paint);
                }
                ...
                if (rotateDegree < 90) {
                    ...
                    matrix.preTranslate(-currBitmap.getWidth() / 2f, -currBitmap.getHeight() / 2f);
                    matrix.postTranslate(currBitmap.getWidth() / 2f + i * averageWidth, currBitmap.getHeight() / 2f);
                    canvas.drawBitmap(currBitmap, matrix, paint);
                } else {
                    camera.save();
                    ...
                    matrix.preTranslate(-nextBitmap.getWidth() / 2f, -nextBitmap.getHeight() / 2f);
                    matrix.postTranslate(nextBitmap.getWidth() / 2f + i * averageWidth, nextBitmap.getHeight() / 2f);
                    canvas.drawBitmap(nextBitmap, matrix, paint);
                }
